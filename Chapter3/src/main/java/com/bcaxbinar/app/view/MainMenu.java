...
public class MainMenu implements Menu {
    ...
    private String menuNumber = null;
    ...
    public void showBody() throws IOException {
        ...
        try {
            ...
            if (menuNumber.isEmpty()) {
                throw new AlfianException("Maaf, Anda belum memasukkan nomor menu. Coba lagi, ya!");
            } else {
                switch (menuNumber) {
                    case "1":
                    case "2":
                    ...
                    case "0":
                        ...
                        break;
                    default:
                        throw new AlfianException("Maaf, masukan nomor menu yang sesuai. Coba lagi, ya!");
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
